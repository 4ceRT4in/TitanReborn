...
public class TitanFabricRecipes {
    ...
    public static final RecipeSerializer<EssenceRecipe> WEAPON_EFFECT_RECIPE_SERIALIZER = RecipeSerializer.register("weapon_effect", new EssenceRecipe.Serializer());
