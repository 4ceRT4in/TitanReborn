...
public class TitanFabricRecipes {
    ...
    public static final RecipeType<WeaponEffectRecipe> WEAPON_EFFECT_RECIPE_TYPE = RecipeType.register("weapon_effect");

    public static final RecipeSerializer<WeaponEffectRecipe> WEAPON_EFFECT_RECIPE_SERIALIZER = RecipeSerializer.register("weapon_effect", new WeaponEffectRecipe.Serializer());
