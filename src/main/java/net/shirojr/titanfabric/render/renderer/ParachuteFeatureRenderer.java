...
public class ParachuteFeatureRenderer<T extends LivingEntity, M extends BipedEntityModel<T>, A extends BipedEntityModel<T>> extends FeatureRenderer<T, M> {
    private static final Identifier PARACHUTE_TEXTURE = TitanFabric.getId("textures/entity/parachute/parachute.png");
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, T entity,
        ...
        parachuteModel.render(matrices, vertexConsumers.getBuffer(RenderLayer.getEntityCutoutNoCull(PARACHUTE_TEXTURE)), light, OverlayTexture.DEFAULT_UV, -1);
        matrices.pop();
    }
}