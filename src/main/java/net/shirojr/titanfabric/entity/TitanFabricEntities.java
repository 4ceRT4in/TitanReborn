...
public class TitanFabricEntities {
    ...
    public static final EntityType<TitanFabricArrowEntity> ARROW_ITEM = Registry.register(Registries.ENTITY_TYPE,
            Identifier.of(TitanFabric.MODID, "arrow_item"),
    ...
    public static final EntityType<CitrinStarEntity> CITRIN_STAR = Registry.register(Registries.ENTITY_TYPE,
            Identifier.of(TitanFabric.MODID, "citrin_star"),
